...
export function renderNovaLinhaExercicio(container, membro = "UPPER") {
    ...
    block.innerHTML = `
        ...
        <div class="sets-wrapper" style="margin-top: 15px;">
            <div class="sets-header" style="display: grid; grid-template-columns: 2fr 1fr 1fr 1.5fr 40px; gap: 8px; margin-bottom: 6px; font-size: 12px; color: #777; font-weight: bold; text-transform: uppercase;">
                <div>Tipo</div><div>Placas</div><div>Carga (kg)</div><div>Repetições</div><div></div>
            </div>
            <div class="sets-container"></div>
            <button type="button" class="btn-add-set" style="margin-top: 8px; background: #222; color: #ccc; border: 1px solid #444; padding: 5px 12px; border-radius: 4px; cursor: pointer; font-size: 13px;">+ Adicionar Série</button>
        </div>
...
export function renderNovaSerie(setsContainer, defaultType = 'Ajuste') {
    ...
    row.innerHTML = `
        ...
        <input type="number" class="set-placas" placeholder="Placas" min="0" style="padding: 7px; background: #1a1a1a; color: #fff; border: 1px solid #333; border-radius: 4px; width:100%; font-size:13px;">
        <input type="number" class="set-load" placeholder="kg" min="0" step="0.5" style="padding: 7px; background: #1a1a1a; color: #fff; border: 1px solid #333; border-radius: 4px; width:100%; font-size:13px;">
        <input type="text" class="set-reps" placeholder="Ex: 8-10" style="padding: 7px; background: #1a1a1a; color: #fff; border: 1px solid #333; border-radius: 4px; width:100%; font-size:13px;">
